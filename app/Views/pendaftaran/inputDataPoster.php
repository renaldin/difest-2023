...
<div class="page-content">
    <div data-aos="zoom-in-down">
        ...
        <?php
        echo form_open_multipart('pendaftaran/insertDataPoster');
        ?>
        <div class="row">
            <div class="col-lg-6">
                <div class="form-daftar">
                    <label>Jenis Perlombaan</label>
                    <input type="text" class="form-control" name="jenis_lomba" value="Desain Poster" disabled>
                </div>
                ...
                <div class="form-daftar">
                    ...
                    <input type="text" class="form-control" name="wa" placeholder="Masukkan Nomor Whatsapp">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-daftar">
