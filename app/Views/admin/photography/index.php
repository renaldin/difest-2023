    ...
    <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
            <div class="tm-bg-primary-dark tm-block tm-block-products">
                ...
                <div class="row mb-2">
                    <div class="col-lg-8">
                        <form action="<?= base_url('photography') ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <?php if ($cari === 'Aktif') { ?>
                                        <a href="<?= base_url('photography') ?>" class="btn btn-secondary" style="float: left;">Clear</a>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            foreach ($photography as $item) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('photography/detail/' . $item['id_pendaftaran_photography']) ?>" class="tm-product-delete-link mb-1">
